 ...
 * @author Zak
 */
public class Doctor13View extends javax.swing.JFrame {
    Connection con;
Statement stmt;
ResultSet rs;
...
JOptionPane.showMessageDialog(this, err.getMessage());
    ...
    private void DoConnect() {
     ...
     String host="jdbc:derby://localhost:1527/Login";
      ...
      String SQL="SELECT * FROM PATIENT WHERE AILMENT LIKE 'gun%' OR AILMENT LIKE 'Gun%' OR AILMENT LIKE 'shot%' OR AILMENT LIKE 'Shot%'";
